        ...
        <main className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center text-blue-900">
            <div className="px-40 flex flex-1 justify-center py-5">
                <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
                    <div className="flex flex-wrap justify-between gap-3 p-4"><p className="text-[#101518] tracking-light text-[32px] font-bold leading-tight min-w-72">Subjects</p></div>
                    <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4"></div>
                    <div className="flex flex-col gap-3 pb-3">
                        {subjects.map((subject) => (
                            <Link to={`/subjects/${subject.name}/decks`} key={subject.name} className="flex flex-col gap-3 pb-3">
                                <div
                                ...
                                ></div>
                                <div>
                                    <p className="text-[#101518] text-base font-medium leading-normal">{subject.name}</p>
                                    <p className="text-[#5c748a] text-sm font-normal leading-normal">Subject</p>
                                </div>
                            </Link>
                        ))}
                    </div>
